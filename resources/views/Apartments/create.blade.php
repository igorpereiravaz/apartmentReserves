...
<body style="background-color:snow;">
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <form role="form" method="POST" action="{{ route('apStore') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="name" name="name" placeholder="Penthouse Cobertura">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="address_complete" name="address_complete" placeholder="Rua Centenaria 112">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Cidade</label>
                <input type="text" class="form-control" id="address_city" name="address_city" placeholder="Curitiba">
            </div>
